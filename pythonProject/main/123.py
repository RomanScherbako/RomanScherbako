...
for ithem in spisok_slov:
    if ithem in counter:
        counter[ithem] = counter[ithem] + 1
    else:
        counter[ithem] = 1
for ithem2 in counter:
    print(ithem2, '-', counter[ithem2])
